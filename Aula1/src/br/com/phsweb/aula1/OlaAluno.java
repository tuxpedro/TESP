...
public class OlaAluno {
	...
	public static void main(String[] args) {
		...
		Professor p1 = new Professor("Pedro", "90090090056", new BigDecimal(10_000));
		Professor p2 = new Professor("Carlos", "19990000909", new BigDecimal(18_000));
		...
		Aluno a4 = new Aluno(222222L, "Cão", "123456789");
